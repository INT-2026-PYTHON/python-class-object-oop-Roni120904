...
"""
class BankAccount:
    def __init__(self, name, account_number, opening_balance=0):  #self refers to the object that is currently uing the method
        self.name = name
...
# Invalid operation for Alice
a1.withdraw(2000)

# Invalid operation for Bob
a2.deposit(-50)

# Valid operation for Bob
a2.deposit(300)
